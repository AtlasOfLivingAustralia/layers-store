CREATE TABLE distributions AS
 ...
 o.the_geom as the_geom_orig, ST_Simplify(o.the_geom,0.1) as the_geom, o.name AS area_name, o.pid, d.type, d.checklist_name, o.area_km, d.notes, d.geom_idx, d.group_name,
